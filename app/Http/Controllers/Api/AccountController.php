...
class AccountController extends Controller
{
    ...
    public function index(Request $request):Response
    {
        ...
        return response ([
            'message' => __('app.data_load_success', ['data' => __('app.accounts')]),
            'results' => [
    ...
    public function get (Request $request, $id):Response {
        ...
        return response ([
            'message' => __('app.data_load_success', ['data'=> __('app.account')]),
            'results' => [
    ...
    public function update (Request $request, $id):Response{
        ...
        return response([
            'message' => __('app.data_update_success', ['data' => __('app.account')]),
            'results' => [
                'account' => new AccountResource($account)
            ]
        ]);
